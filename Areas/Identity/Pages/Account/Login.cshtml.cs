...
namespace FanKart.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(user != null && !user.EmailConfirmed)
                    {
                        ...
                        _emailService.SendEmail(Input.Email, "Verification code from Fankart", "Use this one time password for confirming registration with FanKart " + otp);
