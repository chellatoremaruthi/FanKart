...
using FanKart.Areas.Payment.Data;

namespace FanKart.Areas.OTP.Pages
{
    public class OTPModel : PageModel
    {
        ...
        public async Task OnGet(string orderId)
        {
            ...
            _emailService.SendEmail(User.Identity.Name, "Verification code for your recent order from FanKart", "Use this one time password for confirming your recent order with FanKart " + otp);
